...
def main() -> None:
    ...
    parser.add_argument("--my-templates", action="store_true", help="Opens the folder for you to add your own templates")
   ...
   # Flow 1: If the user passed the --my-templates flag, open the folder and exit the script (sys.exit(0) = success)
    ...
    package_template_path = Path(__file__).resolve().parent / 'app_templates' / args.app_type
    ...
    try:
        ...
        print(f"✨ SUCCESS: App '{args.app_name}' (architecture '{args.app_type}') created!")
