...
class TestMainFunction:
    ...
    def test_main_with_my_templates_flag(
        self, mock_exit: MagicMock, mock_open: MagicMock, mock_args: MagicMock
    ) -> None:
    ...
    def test_main_missing_args(
        self, mock_exit: MagicMock, mock_help: MagicMock, mock_args: MagicMock
    ) -> None:
    ...
    @patch("dj_reframe.cli.argparse.ArgumentParser.parse_args")
    @patch("dj_reframe.cli.sys.exit")
    def test_main_hyphen_in_app_name(
        self, mock_exit: MagicMock, mock_args: MagicMock
    ) -> None:
